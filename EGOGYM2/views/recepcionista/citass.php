        ...
        <div class="tab-content">
         ...
         <form action="../../scripts/guardaCitas.php" method="post" style="background-color:black; opacity:0.8; border-radius:5px; width:80%; padding:7%;">
            <div class="row">
                  ...
                  <input type="text" name="cliente" placeholder="ID del cliente" readonly
                  value="<?php echo "$idPersona" ?>"><br> 
                    <?php
                    $db=new database();
                    $db->conectarDB();
      ...
      <div id="agendar_fisio" class="tab-pane fade">
        <form action="../../scripts/guardaCitas.php" method="post" style="background-color:black; opacity:0.8; border-radius:5px; width:80%; padding:7%">
            <div class="row">
                  ...
                  <div class="col-12 col-lg-6">
                  <label style='color: white;'>Cliente</label><br>
                  <input type="text" name="cliente" placeholder="ID del cliente" required readonly
                  value="<?php echo "$idPersona" ?>"><br> 
