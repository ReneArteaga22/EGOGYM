...
if($pass)
{
    ...
    <div>
      <p style='margin-left:13px; font-size: 20px;'>Se ha actualizado la membresia correctamente
    </div>
  </div>
  ";  
...
else
{
    ...
    <div>
    <p style='margin-left:13px; font-size: 20px;'> No se ha podido actualizar la membresia </p>
    </div>
  </div>
  ";     
  header("refresh:2 ../views/recepcionista/perfilCliente.php?id=".$clienteId."");
