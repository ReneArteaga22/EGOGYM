...
if($conexion->ejecutarSQL($upcontra))
{
    $pass = true;
}
...
if($pass)
{
  ...
  <div>
    <p style='margin-left:13px; font-size: 20px;'>Se ha actualizado la contraseña correctamente
  </div>
</div>
";  
}
else
{
    ...
    <div>
    <p style='margin-left:13px; font-size: 20px;'> No se ha podido actualizar la contraseña </p>
    </div>
  </div>
  ";     
}
