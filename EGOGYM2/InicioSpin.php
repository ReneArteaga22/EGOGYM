...
<html>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a href="../nutriologo/citas_nutri.php" class="nav-link smoothScroll">Clases</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="card-body row">
            ...
            <img src="images/fp.jpg" style="width: 40%; align-self: center; margin: 10px;" class="rounded-circle" alt="..." style="width: 60%;">
          </div>
        <?php
        ...
        where persona.id_persona in (select entrenador.id_ent from entrenador)";
